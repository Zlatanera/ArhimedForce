...
{
  func displaySomething(viewModel: FirstScene.Something.ViewModel)
}

class FirstSceneViewController: UIViewController, FirstSceneDisplayLogic
{
  ...
  func doSomething()
  {
    let request = FirstScene.Something.Request()
